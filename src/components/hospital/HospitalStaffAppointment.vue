        ...
        <div class="container-fluid mt-5">
            <div class="row">
                ...
                <div class="col-md-9 order-md-1">
                    <h4  v-if="appointments.length <= 0" class="mb-3 h3 d-flex justify-content-center">Appointment Logs</h4>
    ...
    export default {
        ...
        async created() {
            ...
            for (let i=appointmentCount; i>0; i--) {
                ...
                if (this.getIntFromBN(appointment.hospital) === this.hospital) {
