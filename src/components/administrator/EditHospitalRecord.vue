    ...
    export default {
        ...
        methods: {
            handleRegisterHospitalRquest() {
                ...
                this.blockchainHealthRecord.methods.updateHospitalAccount(
                    this.form.id,
                    this.form.userId, 
                    ...
                    .then((receipt) => {
                        ...
                        if (response.returnValues.errorMessage) {
                            ...
                            alert("Hospital record was updated successfully")
                            this.isLoading = false
                            this.$router.push({ 
        ...
        async mounted() {
            ...
            const hospital = await this.blockchainHealthRecord.methods.hospitals(hospitalID).call()
            this.form.id = this.getIntFromBN(hospital.id)
            this.form.userId = hospital.userId
            this.form.name = hospital.name
            this.form.registrationNumber = hospital.registrationNumber
            this.form.accountType = hospital.accountType
            this.form.email = hospital.email
            this.form.mobile = hospital.mobile
            this.form.contactAddress = hospital.contactAddress
        }
    }
</script>
